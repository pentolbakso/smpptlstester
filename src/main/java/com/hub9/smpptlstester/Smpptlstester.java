package com.hub9.smpptlstester;
 ...
 * @author bayufa
 */
public class Smpptlstester {

private static final Logger logger = LoggerFactory.getLogger(Smpptlstester.class);

    static public void main(String[] args) throws Exception {
        System.out.println("Starting tester...");
        
        if (args.length < 4) {
            System.out.println("invalid arguments!\nvalid argument example: Smpptlsters.jar 10.10.10.1 8800 systemid password");
            return;
        }
        ...
        System.out.println("connecting to smppserver "+ip+":"+port+" systemId:"+systemId);
